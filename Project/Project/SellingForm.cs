...
namespace Project
{
    public partial class SellingForm : Form
    {
        public SellingForm()
        {
         ...
         // SQL connection
        SqlConnection con = new SqlConnection(@"Data Source=DESKTOP-MLCMUF7;Initial Catalog=Mydb;Integrated Security=True");// database cannection
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            try
            {
                e.Graphics.DrawString("Ledger Management System", new Font("Century Gothic", 25, FontStyle.Bold), Brushes.Red, new Point(230));
